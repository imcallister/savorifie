...
var last_upload_headers = [{fld: 'Upload', label: 'Upload'},
                           {fld: 'Last Upload', label: 'Last Upload', formatter: formatters.date}
                           ];

var payables_headers  = [{'fld': 'counterparty', 'label': 'Payee'},
                          {'fld': 'amount', 'label': 'Amount', formatter: formatters.drill}
                          ];



var SWATCH_COLORS = {banking: 'dbpanel-plum',
                     mastercard: 'dbpanel-ocean',
                     expenses: 'dbpanel-slate'
                 };


class PayablesView extends React.Component {
...
export default connect(mapStateToProps)(PayablesView);
export { PayablesView as PayablesViewNotConnected };
