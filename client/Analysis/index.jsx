    ...
    render() {
        return (
            <div className="container">
                <HighChartContainer chartName="inventory.totalsales"
                            source="/chart/sales/sale_count/"
                />
                ...
                <div className="text-center">
                    <h1>And this is where we do Analysis</h1>
                </div>
...
export { AnalysisView as AnalysisViewNotConnected };
